  ...
  return (
    <ThemeProvider theme={AppTheme}>
      ...
      <section className='h-screen w-full flex flex-col border-2 gap-y-10 items-center'>
        {/* Header */}
        <div className="container flex justify-between items-center px-10 py-6 shadow-2xl">
        ...
        <div className="container flex justify-between max-lg:flex-col px-10 mx-auto shadow-2xl py-6">
          <div className="flex relative w-1/2 max-lg:w-full items-center">
            <TextField
              label="Todo Name"
              value={input}
